...
import categoriesExpertApi from "../api/categoryExpertApi";
function CategoryExpertAdmin() {
    const loadPage = "";
    ...
    useEffect(() => {
      ...
      async function fetchCategoriesList() {
        try {
          const response = await categoriesExpertApi.getAll();
    ...
    async function DeleteCategory(id) {
      try {
        setLoading(true);
        await categoriesExpertApi.remove(id);
        setPageLoad(id);
        setLoading(false);
      } catch (error) {
        setError(true);
    ...
    async function addNewCategory() {
      try {
        setLoading(true);
        const response = await categoriesExpertApi.create(category);
        setLoading(false);
      } catch (error) {
        setError(true);
      }
    ...
    async function updateCategory() {
      try {
        setLoading(true);
        const response = await categoriesExpertApi.update(idUpdate, category);
        setLoading(false);
      } catch (error) {
        setError(true);
      }
...
export default CategoryExpertAdmin