import CategoryActivityModel from '../models//categoriesFieldOfActivity.js'
...
export const update = async (req,res) => {
    try {
      ...
      const category = await CategoryActivityModel.findByIdAndUpdate({ _id: req.params.id }, updateCategory, {new : true})// data updated is new data
